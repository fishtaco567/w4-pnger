...
fn main() {
    ...
    match matches.subcommand_name() {
        Some("convert") => {
            ...
            let (output_type, output_file) = if let Some(output_file) = matches.get_one::<String>("rs") {
            ...
            Converter::new(path, output_file, OutputType::from_str(output_type), compress).run();
        }
